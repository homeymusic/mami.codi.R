...
p = params %>% purrr::map(\(p) {
  ...
  print(knitr::kable(tibble::tibble_row(
    ...
    frequency_tolerance     = paste(round(chords$frequency_tolerance %>% unique, 5), collapse = ' '),
  ...
  print(plot_semitone_cowave.cofreq(chords, title='Uncalibrated Space and Time Consonance',
                                    goal=NULL,sigma=sigma,calibrated=F,
                                    black_vlines=black_vlines,gray_vlines=gray_vlines))
  
  print(plot_semitone_cowave.cofreq(chords, title='Space and Time Consonance',
                                    goal=NULL,sigma=sigma,calibrated=T,
                                    black_vlines=black_vlines,gray_vlines=gray_vlines))
  cat("  \n")
