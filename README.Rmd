...
* The dyads immediately below, from the timbre study, are true two-pitch dyads. 
True major thirds like C4 and E4, for example, only include C4 and E4.
...
* Two-pitch dyads versus octave-framed, three-pitch chords, might have different 
major-minor polarities
...
(dyads %>% dplyr::filter(scale=='5PartialsNo3') %>% dplyr::slice(1))$spectrum[[1]]

```{r, fig.height=8, fig.width=12, echo=F, results='hide', message=F}
params = list(
