...
$$\lambda_{0} = \lambda_{max} { ALCD}\left(\psi_{\lambda} \right)$$

$$\psi_{\lambda} = 
\left(
\frac{\lambda_{min}}{\lambda_{min}} \pm \sigma_{\lambda}^{2}, 
\frac{\lambda_{i}}{\lambda_{min}} \pm \sigma_{\lambda}^{2},
\cdots, 
...
$$f_{0} = f_{max} / { ALCD}\left(\psi_{\lambda} \right)$$

$$\psi_{f} = 
\left(
\frac{f_{min}}{f_{min}} \pm \sigma_{f}^{2}, 
\frac{f_{i}}{f_{min}} \pm \sigma_{f}^{2},
\cdots, 
\frac{f_{N}}{f_{min}} \pm \sigma_{f}^{2}\right) = 
\left(
1, 
\frac{c_{i}}{d_{i}}, 
\cdots,
\frac{c_{N}}{d_{N}}\right)
$$ $${ GCD}(c_{i}, d_{i}) = 1$$
...
$$D_{\lambda} = \log_{2} \left({ ALCD}\left(\psi_{\lambda}\right)\right)$$

Temporal Dissonance

$$D_{f} = \log_{2} \left({ ALCD}\left(\psi_{f}\right)\right)$$

Total Dissonance

$$D_{\lambda f} = D_{\lambda} + D_{f}$$

Major-Minor

$$M_{\lambda f} = C_{\lambda} - C_{f}$$ Major chords will have positive
$M_{\lambda f}$, minor chords negative and neutral chords 0.
...
![](man/figures/README-unnamed-chunk-5-54.png)<!-- -->  
![](man/figures/README-unnamed-chunk-5-55.png)<!-- -->
