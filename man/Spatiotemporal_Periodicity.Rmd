...
with 5 harmonics per pitch. The MaMi.CoDi model is based on 
...
##### Wavelength Ratios
```{r, echo=F, results='asis', message=F}
knitr::kable(chord$wavelength_ratios[[1]] %>% 
               dplyr::arrange(ratio) %>% 
               dplyr::rename(
                 tone_m = tone,
...
Below, we estimate the periodicity of the C4 and Eb4 minor third dyad with 5 harmonics per pitch.\
