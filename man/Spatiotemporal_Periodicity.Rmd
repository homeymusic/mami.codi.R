...
processing technique. It finds ratios, within a given precision, 
...
knitr::kable(tibble::tibble(
  tol      = chord$temporal_precision,
  lcd      = chord$temporal_lcm_den,
  chord_Sz = log2(lcd),
...
```{r, echo=F, results='asis', message=F}
knitr::kable(tibble::tibble(
  tol      = chord$spatial_precision,
  lcd      = chord$spatial_lcm_den,
  chord_Sz = log2(lcd),
