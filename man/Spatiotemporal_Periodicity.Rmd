...
#### Frequency Ratios
```{r, echo=F, results='asis', message=F}
knitr::kable(chord$temporal_ratios[[1]] %>% dplyr::arrange(ratio) %>% dplyr::select(-pseudo_ratio))
```
...
##### Wavelength Ratios
```{r, echo=F, results='asis', message=F}
knitr::kable(chord$spatial_ratios[[1]] %>% dplyr::arrange(ratio) %>% dplyr::select(-pseudo_ratio))
```
