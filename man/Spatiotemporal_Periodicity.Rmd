...
of those ratios is a measure of the cycle length, relative to the reference tone.\

MaMi.CoDi creates two estimates of the chord's period: a spatial estimate and 
a temporal estimate.\
...
* Frequencies: `r midi %>% hrep::midi_to_freq()`\

* Wavelengths: `r SPEED_OF_SOUND / (midi %>% hrep::midi_to_freq())`\
...
```{r, echo=F, results='asis', message=F}
knitr::kable(tibble::tibble(
  tol      = chord$wavelength_tolerance,
