...
theory <- theory %>% dplyr::rowwise() %>% dplyr::mutate(
  ...
  consonance     = max_dissonance - .data$dissonance,
  temporal_consonance = max_dissonance - .data$temporal_dissonance,
  spatial_consonance  = max_dissonance - .data$spatial_dissonance,
  .before=1
