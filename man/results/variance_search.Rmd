...
theory <- theory %>% 
  ...
  dplyr::group_by(temporal_standard_deviation, spatial_standard_deviation)  # Group by both variables
```
...
theory <- theory %>% 
  dplyr::mutate(
    smooth_temporal = smoothed(semitone, -temporal_dissonance, params$sigma),
    smooth_spatial  = smoothed(semitone, -spatial_dissonance, params$sigma)
  )
