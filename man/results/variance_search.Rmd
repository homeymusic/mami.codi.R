...
theory <- theory %>% 
  dplyr::mutate(
    smooth_temporal = smoothed(semitone, max(log2_temporal_cycles) - log2_temporal_cycles, params$sigma),
    smooth_spatial  = smoothed(semitone, max(log2_spatial_cycles) - log2_spatial_cycles, params$sigma)
  )
