...
#### The Fundamentals
    ...
    * The state of a tone ratio is described by a Stern-Brocot (SB) function 
    which is the probability of the tone ratio's rational fraction approximation.
        ...
        * The SB distribution has standard_deviation $\sigma^2$.
    ...
    * The standard_deviations of the wavelength and frequency standard_deviation are governed by 
...
standard_deviation using the Stern-Brocot tree.
...
$f(x)$ and $g(x)$ are both probabilities. The product of their standard_deviation satisfies
