...
```{r, echo=F, results='asis', message=F}
knitr::kable(chord %>% dplyr::select('dissonance', 'major', 'temporal_consonance', 'spatial_consonance'))
```

###### MaMi.CoDi Predictions 2
```{r, echo=F, results='asis', message=F}
knitr::kable(chord %>% dplyr::select('dissonance_2', 'major_2', 'temporal_consonance_2', 'spatial_consonance_2'))
```
