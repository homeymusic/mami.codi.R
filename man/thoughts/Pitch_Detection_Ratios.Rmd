...
```{r, echo=F, results='asis', message=F}
knitr::kable(chord %>% dplyr::select('dissonance', 'major', 'log2_temporal_cycles', 'log2_spatial_cycles'))
```

###### MaMi.CoDi Predictions 2
```{r, echo=F, results='asis', message=F}
knitr::kable(chord %>% dplyr::select('dissonance_2', 'major_2', 'log2_temporal_cycles_2', 'log2_spatial_cycles_2'))
```
