...
tonic_midi = 60
temporal_frequency_sd = mami.codi.R::default_variance()
```
...
P8 = grid_P8 %>% purrr::pmap_dfr(\(temporal_frequency_sd,
                              interval,
                              num_harmonics,
                              octave_ratio,
                              timbre) {
...
M6 = grid_M6 %>% purrr::pmap_dfr(\(temporal_frequency_sd,
                              interval,
                              num_harmonics,
                              octave_ratio,
                              timbre) {
...
M3 = grid_M3 %>% purrr::pmap_dfr(\(temporal_frequency_sd,
                              interval,
                              num_harmonics,
                              octave_ratio,
                              timbre) {
