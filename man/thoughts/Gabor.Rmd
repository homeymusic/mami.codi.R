...
dimension, frequency of the signal (f), measured in 1 / seconds.\
...
Do sound waves have mass? [Sound Waves Carry Mass](https://physics.aps.org/articles/v12/23)\
...
Wavelength ratio precision x Frequency ratio precision  = Number of the order one\
