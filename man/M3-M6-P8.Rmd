...
Those secondary and tertiary dissonance troughs pull 
the curves down forming the smoothed shapes we see for 
...
title = "Consonance Peak in Dissonance Troughs at P1"
tonic_midi    = 60
span          = 5
...
That is to say, at the resolution of 10 semitones,
...
As the tolerance value of the MaMi.CoDi model increases
the consonance peaks expand width until they over come the dissonance peaks.
See plots, below.\
