...
the curves down forming the shapes we see for both 
the theoretical predictions for M3 and M6.\
...
title = "Dissonance Trough with Centered Consonance Peak at P1"
tonic_midi    = 60
span          = 5
...
highly dissonant neighbors on both sides, M7 and m2.
