run_trials <- function(search_label, cochlear_amplifier_num_harmonics) {
  devtools::load_all(".")
  ...
  print(search_label)
  print(paste('cochlear_amplifier_num_harmonics:',cochlear_amplifier_num_harmonics))
  print(paste('octave_ratio:',octave_ratio))
  print(paste('num_harmonics:',num_harmonics))
  print(paste('roll_off:',roll_off))

  output_rds = paste0('./man/data/output/cochlear_amplifier_num_harmonics_',
               search_label,
               '.rds')
  prepare(output_rds)
