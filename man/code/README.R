...
grid_Bonang = tidyr::expand_grid(
  temporal_frequency_sd = default_variance / 2,
  interval = readRDS(experiment.rds)$profile$interval,
  num_harmonics=4,
  octave_ratio=2,
  timbre = 'Bonang'
...
grid_5 = tidyr::expand_grid(
  temporal_frequency_sd = default_variance,
  interval = readRDS(experiment.rds)$profile$interval,
  num_harmonics=5,
  octave_ratio=2.0,
  timbre='5Partials'
...
grid_P8_zoomed_spatial = tidyr::expand_grid(
  temporal_frequency_sd = TEMPORAL_FREQUENCY_SD_DEFAULT / 5e-05,
  interval = readRDS(experiment.rds)$profile$interval,
  num_harmonics=10,
  octave_ratio=2.0,
...
output = grid %>% furrr::future_pmap_dfr(\(temporal_frequency_sd,
                                           interval,
                                           num_harmonics,
                                           octave_ratio,
                                           timbre) {
