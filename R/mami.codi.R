...
compute_consonance = function(x, amplitude,
  ...
  x %>% dplyr::mutate(
    ...
    temporal_consonance   = 1 / log2(1+.data$temporal_alcd),
    spatial_consonance    = 1 / log2(1+.data$spatial_alcd),

    consonance_dissonance = 1 / log2(.data$temporal_alcd + .data$spatial_alcd),
