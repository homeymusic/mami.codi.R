...
#'     )
#'   }
#' @param oae_num_harmonics Number of harmonics to include for the stimulus-frequency otoacoustic emission.
...
#'
#' @param x Wavelength and frequency spectra representing the stimulus.
#' @param oae_num_harmonics Number of harmonics emitted from the cochlea via SFOAE.
#'
...
#' Generate combination tones
#'
#' @param x Wavelength and frequency spectra representing the stimulus tones.
#' @param combination_tones Number of harmonics emitted from the cochlea via SFOAE.
#'
#' @return Combined frequency and wavelength spectra for the combination tones
#'
...
COMBINATION_COEFFICIENTS=c(-1,1)
