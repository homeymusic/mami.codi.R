...
# TODO: does SFOAE respond to wavelengths stimulus? or frequencies stimulus?
# Right now I am assuming frequency. but if the SFOAE starts with OHC which has
...
#' @export
default_oae_num_harmonics <- function() { OAE_NUM_HARMONICS }
OAE_NUM_HARMONICS = 2
