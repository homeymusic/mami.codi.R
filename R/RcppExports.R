...
approximate_rational_fractions <- function(x, uncertainty, deviation, metadata = "") {
    .Call(`_mami_codi_R_approximate_rational_fractions`, x, uncertainty, deviation, metadata)
}
